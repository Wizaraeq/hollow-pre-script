...
function s.spfilter(c,e,tp)
	return c:IsFaceupEx() and c:IsSetCard(0x2db) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.cfilter(c,tp)
	return c:IsFaceup() and c:IsSetCard(0x2db) and c:IsSummonPlayer(tp)

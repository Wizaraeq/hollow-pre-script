...
function c100290036.initial_effect(c)
	...
	e3:SetCountLimit(1,100290036+100)
	e3:SetCost(aux.bfgcost)
	e3:SetTarget(c100290036.destg)
	e3:SetOperation(c100290036.desop)
	c:RegisterEffect(e3)
end
function c100290036.spcfilter(c,tp)
	return c:IsControler(tp) and c:IsAttribute(ATTRIBUTE_EARTH)
end
function c100290036.spcon(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c100290036.spcfilter,1,nil,tp)
end
...
function c100290036.destg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local g2=Duel.SelectTarget(tp,Card.IsAttackPos,tp,0,LOCATION_MZONE,1,1,nil)
	e:SetLabelObject(g1:GetFirst())
	Duel.SetOperationInfo(0,CATEGORY_DESTROY,g2,1,0,0)
end
function c100290036.desop(e,tp,eg,ep,ev,re,r,rp)

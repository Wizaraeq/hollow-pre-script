...
function c100291001.thcfilter(c)
	return c:IsRace(RACE_FAIRY+RACE_FIEND+RACE_REPTILE)
end
function c100291001.thcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroup(tp,c100291001.thcfilter,1,nil) end
	local g=Duel.SelectReleaseGroup(tp,c100291001.thcfilter,1,1,nil)
	Duel.Release(g,REASON_COST)
end

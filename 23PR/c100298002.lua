...
function c100298002.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(100298002,0))
	e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e1:SetProperty(EFFECT_FLAG_DELAY)
	e1:SetCode(EVENT_SPSUMMON_SUCCESS)
	e1:SetCountLimit(1,100298002)
	e1:SetCondition(c100298002.efcon)
	e1:SetTarget(c100298002.efftg)
	e1:SetOperation(c100298002.effop)
	c:RegisterEffect(e1)
	...
	e1a:SetValue(c100298002.matcheck)
	c:RegisterEffect(e1a)
end
function c100298002.efcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetLabel()>0 and e:GetHandler():IsSummonType(SUMMON_TYPE_SYNCHRO) 
end
function c100298002.efftg(e,tp,eg,ep,ev,re,r,rp,chk)
	local lb=e:GetLabel()
	...
	Duel.Hint(HINT_OPSELECTED,1-tp,aux.Stringid(100298002,index))
end
function c100298002.effop(e,tp,eg,ep,ev,re,r,rp)
...
function c100298002.matcheck(e,c)

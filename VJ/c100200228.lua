--閃刀姫－アザレア
--Script by 奥克斯
function c100200228.initial_effect(c)
	c:SetSPSummonOnce(100200228)
	--link summon
	...
	e1:SetTarget(c100200228.destg1)
	e1:SetOperation(c100200228.desop1)
	c:RegisterEffect(e1)
	--bp destroy
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringid(100200228,1))
...
function c100200228.desop1(e,tp,eg,ep,ev,re,r,rp)

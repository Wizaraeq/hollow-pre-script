...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--1 monster your opponent controls loses 600 ATK if this card is Special Summoned
	...
	c:RegisterEffect(e2)
	--1 monster your opponent controls loses 400 ATK if this card is destroyed and sent to the GY

...
function c101106088.initial_effect(c)
	...
	e1:SetCondition(c101106088.imcon)
	e1:SetOperation(c101106088.imop)
	c:RegisterEffect(e1)
	--Special Summon
	local e2=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(101106088,0))
...
function c101106088.imcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsSummonType(SUMMON_TYPE_FUSION)
end
function c101106088.imop(e,tp,eg,ep,ev,re,r,rp)
...
function c101106088.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsControler(tp) and chkc:IsLocation(LOCATION_GRAVE) and c101106088.spfilter(chkc,e,tp) end

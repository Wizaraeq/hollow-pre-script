...
function s.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if Duel.CheckReleaseGroup(tp,s.cfilter,1,nil,tp) and (Duel.GetLocationCount(tp,LOCATION_MZONE)<=0
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(s.filter),tp,LOCATION_GRAVE+LOCATION_HAND+e:GetLabel(),0,1,1,nil,e,tp)

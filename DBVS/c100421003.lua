...
function s.cfilter(c)
	return c:IsFaceup() and not c:IsSetCard(0x2a1)
end
...
function s.dfilter(c,tp)
	return c:IsFaceup() and c:IsSetCard(0x2a1) and Duel.IsExistingMatchingCard(s.filter,tp,LOCATION_DECK,0,1,nil,c:GetOriginalLevel())
end

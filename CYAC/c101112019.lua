...
function c101112019.initial_effect(c)
	...
	e1:SetCondition(c101112019.ndcon)
	e1:SetValue(1)
	c:RegisterEffect(e1)
	...
	e2:SetValue(1)
	e2:SetCondition(c101112019.indcon)
	c:RegisterEffect(e2)
	...
	e5:SetCountLimit(1,101112019)
	e5:SetTarget(c101112019.thtg)
	e5:SetOperation(c101112019.thop)
	c:RegisterEffect(e5)
end
function c101112019.ndcon(e)
...
function c101112019.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c101112019.thfilter,tp,LOCATION_DECK,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
end
function c101112019.thop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectMatchingCard(tp,c101112019.thfilter,tp,LOCATION_DECK,0,1,1,nil)

...
function c101112022.initial_effect(c)
	...
	e3:SetCondition(c101112022.poscon)
	e3:SetTarget(c101112022.poscon)
...
function c101112022.cfilter(c,tp)
	return c:IsRace(RACE_MACHINE) and c:IsAttribute(ATTRIBUTE_EARTH)
		and c:IsPreviousControler(tp) and c:IsPreviousLocation(LOCATION_MZONE) and not c:IsFacedown()
end

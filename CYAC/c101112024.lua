...
function c101112024.initial_effect(c)
	...
	e2:SetTarget(c101112024.tg)
	e2:SetOperation(c101112024.op)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
...
function c101112024.tg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c101112024.op(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetCountLimit(1)
	e1:SetOperation(c101112024.todop)
	e1:SetReset(RESET_PHASE+PHASE_END)
	Duel.RegisterEffect(e1,tp)
end
function c101112024.todop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Hint(HINT_CARD,0,101112024)

...
function c101112080.initial_effect(c)
	...
	e1:SetTarget(c101112080.cftg)
	e1:SetOperation(c101112080.cfop)
	c:RegisterEffect(e1)
end
function c101112080.cftg(e,tp,eg,ep,ev,re,r,rp,chk)
	local g=Duel.GetDecktopGroup(1-tp,5)
	if chk==0 then return g:FilterCount(Card.IsAbleToHand,nil,tp)>0 end
	Duel.SetTargetPlayer(tp)
end
function c101112080.cfop(e,tp,eg,ep,ev,re,r,rp)

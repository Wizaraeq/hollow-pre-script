...
function s.actlim(e,re,tp)
	...
	return re:IsActiveType(TYPE_MONSTER)
		and (e:GetHandler():GetColumnGroup():IsContains(tc)
		or tc:GetColumnGroup():IsExists(s.lfilter,1,nil,e:GetHandlerPlayer()))
		and efftyp&EFFECT_TYPE_SINGLE>0 and ((efftyp&EFFECT_TYPE_TRIGGER_O)>0 or (efftyp&EFFECT_TYPE_TRIGGER_F))
		and (effcod&EVENT_SUMMON_SUCCESS>0 or effcod&EVENT_SPSUMMON_SUCCESS>0)
end

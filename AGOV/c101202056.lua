...
function s.cfilter(c)
	local p=c:GetOwner()
	return c:IsSetCard(0x2a0) and c:IsType(TYPE_MONSTER) and Duel.GetLocationCount(p,LOCATION_SZONE)>0
...
function s.spfilter(c,e,tp)
	return c:IsFaceup() and c:GetOriginalType()&TYPE_MONSTER>0 and c:GetType()&TYPE_CONTINUOUS+TYPE_SPELL==TYPE_CONTINUOUS+TYPE_SPELL and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end

...
function c101201019.initial_effect(c)
	...
	e2:SetCountLimit(1,101201019+100)
	e2:SetTarget(c101201019.settg)
...
function c101201019.settg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c101201019.setfilter,tp,LOCATION_DECK,0,1,nil) end
end
function c101201019.setop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SET)
	local g=Duel.SelectMatchingCard(tp,c101201019.setfilter,tp,LOCATION_DECK,0,1,1,nil)
	if #g>0 then
		Duel.SSet(tp,g)
	end
end

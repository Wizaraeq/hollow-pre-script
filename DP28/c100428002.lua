...
function s.spcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetMatchingGroupCount(s.scfilter,tp,LOCATION_GRAVE,0,nil)>=2
end
...
function s.spdtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(1-tp,LOCATION_MZONE,tp)>0 and c:IsAbleToDeck() and Duel.IsPlayerCanDraw(tp,1)

...
function c101106075.discon(e,tp,eg,ep,ev,re,r,rp)   
	return Duel.GetCurrentChain()==0 and Duel.GetTurnPlayer()~=tp and rp==1-tp and Duel.IsExistingMatchingCard(c101106075.cfilter1,tp,LOCATION_MZONE,0,1,nil) and not Duel.IsExistingMatchingCard(c101106075.cfilter2,tp,LOCATION_MZONE,0,1,nil)
end

...
function s.atkfilter(c)
	return c:IsSetCard(0x9b) and c:IsType(TYPE_FUSION) and c:IsFaceup()
end
function s.tgfilter(c)
	return c:IsSetCard(0x9b) and c:IsType(TYPE_MONSTER) and c:IsAbleToGrave()
end
...
function s.thfilter(c)
	return c:IsSetCard(0x9b) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand() and not c:IsCode(id)
end
...
function s.cfilter(c,tp)
	return c:IsFaceup() and c:IsSetCard(0x9b) and c:IsType(TYPE_FUSION) and c:IsControler(tp)
end

...
function s.drwcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsSummonType(SUMMON_TYPE_RITUAL) and Duel.IsExistingMatchingCard(s.dcfilter,tp,LOCATION_ONFIELD+LOCATION_GRAVE,0,1,nil)
end
...
function s.cfilter(c)
	return c and c:IsFaceup() and c:IsAttribute(ATTRIBUTE_LIGHT) and c:IsRace(RACE_WARRIOR+RACE_DRAGON) and c:IsType(TYPE_RITUAL)
end

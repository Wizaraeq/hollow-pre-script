...
function c101104082.filter(c,tp)
	return c:GetOriginalAttribute()==ATTRIBUTE_EARTH and c:GetOriginalRace()==RACE_FAIRY and c:IsPreviousLocation(LOCATION_HAND+LOCATION_MZONE) and c:GetPreviousControler()==tp
end

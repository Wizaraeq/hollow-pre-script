...
function s.initial_effect(c)
	...
	e3:SetTarget(aux.TargetBoolFunction(Card.IsCode,100245038))
...
function s.thfilter(c,e,tp,ec)
	if not (c:IsSetCard(0x2d6) and c:IsType(TYPE_MONSTER)) then return false end

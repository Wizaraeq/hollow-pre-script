...
function s.initial_effect(c)
	...
	c:EnableReviveLimit()
	--Search 1 "White Woods" card or 1 LIGHT Spellcaster monster
...
function s.thfilter(c)
	return (c:IsSetCard(0x2b3) or (c:IsAttribute(ATTRIBUTE_LIGHT) and c:IsRace(RACE_SPELLCASTER))) and c:IsAbleToHand()
end

...
function s.initial_effect(c)
	--Special Summon 1 "White Woods" monster
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0x2b3) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.scfilter(c)
	return c:IsSetCard(0x2b3) and c:IsSynchroSummonable(nil)
end

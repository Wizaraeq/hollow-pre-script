...
function s.counterfilter(c)
	return not c:IsSummonType(SUMMON_TYPE_RITUAL) or c:IsRace(RACE_MACHINE)
end
...
function s.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	--Cannot Ritual Summon, except Machine monsters
...
function s.thfilter(c)
	return c:IsSetCard(0x154) and c:IsType(TYPE_MONSTER) and not c:IsCode(id) and c:IsAbleToHand()
end

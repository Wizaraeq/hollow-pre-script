...
function s.initial_effect(c)
	...
	e2:SetCategory(CATEGORY_EQUIP+CATEGORY_SPECIAL_SUMMON+CATEGORY_DECKDES)
...
function s.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsFaceup() and tc:IsRelateToEffect(e) then
		...
		c:RegisterEffect(e2)
		if tc:IsAttribute(ATTRIBUTE_DARK+ATTRIBUTE_LIGHT) and Duel.GetLocationCount(tp,LOCATION_MZONE)>0

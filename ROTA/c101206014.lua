...
function s.filter(c)
	return c:IsSetCard(0x1b0) and not c:IsCode(id) and c:IsAbleToGrave()
end
function s.tgtg(e,tp,eg,ep,ev,re,r,rp,chk,_,exc)
...
function s.spfilter(c,e,tp)
	return c:IsFaceup() and c:IsSetCard(0x1b0) and c:IsType(TYPE_LINK) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end

...
function c101106057.initial_effect(c)
	...
	e1:SetTarget(c101106057.target)
	e1:SetOperation(c101106057.activate)
	c:RegisterEffect(e1)
end
...
function c101106057.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) then
		...
		local chkf=tp
		local mg1=Duel.GetFusionMaterial(tp):Filter(c101106057.filter1,nil,e)
		local sg1=Duel.GetMatchingGroup(c101106057.filter2,tp,LOCATION_EXTRA,0,nil,e,tp,mg1,nil,chkf)
		local mg2=nil
		local sg2=nil

...
function c101106006.initial_effect(c)
	...
	e3:SetCondition(c101106006.remcon)
	e3:SetTarget(c101106006.remtg)
	e3:SetOperation(c101106006.remop)
	c:RegisterEffect(e3)
end
...
function c101106006.descon(e,tp,eg,ep,ev,re,r,rp)
	...
	return a and d and a:IsFaceup() and a:IsRelateToBattle() and a:IsRace(RACE_WYRM) 
		and d:IsFaceup() and d:IsRelateToBattle() and d:GetSummonLocation()==LOCATION_EXTRA
end
...
function c101106006.remfilter(c)
...
function c101106006.remtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local op=0
	if b1 and b2 then
		op=Duel.SelectOption(tp,aux.Stringid(101106006,3),aux.Stringid(101106006,4))
	else
		op=2
	end
...
function c101106006.remop(e,tp,eg,ep,ev,re,r,rp)

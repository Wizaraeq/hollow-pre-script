...
function c101105086.initial_effect(c)
	...
	e3:SetCountLimit(1,101105086+100)
	e3:SetCondition(c101105086.descon)
	e3:SetCost(c101105086.descost)
	e3:SetTarget(c101105086.destg)
	e3:SetOperation(c101105086.desop)
	c:RegisterEffect(e3)
end
function c101105086.spfilter(c,tp)
	return c:IsFaceup() and c:IsControler(tp) and c:IsRace(RACE_INSECT)
end
function c101105086.spcon(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c101105086.spfilter,1,nil,tp)
end
...
function c101105086.descon(e,tp,eg,ep,ev,re,r,rp)
...
function c101105086.descost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c101105086.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetOperationInfo(0,CATEGORY_DESTROY,eg,1,0,0)
end
function c101105086.desop(e,tp,eg,ep,ev,re,r,rp)

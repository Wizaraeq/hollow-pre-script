...
function s.repfilter(c,tp)
	return c:IsFaceup() and c:IsSetCard(0xb5) and c:IsLocation(LOCATION_ONFIELD)
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0xb5) and not c:IsCode(id) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end

...
function c100417013.initial_effect(c)
	...
	e1:SetCondition(c100417013.hspcon)
	e1:SetTarget(c100417013.hsptg)
	e1:SetOperation(c100417013.hspop)
	c:RegisterEffect(e1)
	-- Special Summon Xyz
...
function c100417013.hspcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c100417013.cfilter1,tp,LOCATION_MZONE,0,1,nil)
end
function c100417013.hsptg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c100417013.hspop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if c:IsRelateToEffect(e) and Duel.SpecialSummon(c,0,tp,tp,false,false,POS_FACEUP)>0 
		and Duel.IsExistingMatchingCard(c100417013.cfilter2,tp,LOCATION_ONFIELD,0,1,nil) then
		Duel.BreakEffect()
...
function c100417013.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	local c=e:GetHandler()

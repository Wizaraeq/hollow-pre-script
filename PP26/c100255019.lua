...
function s.thfilter(c)
	return (c:IsCode(100200282) or aux.IsCodeListed(c,100200282) and c:IsType(TYPE_MONSTER)) and c:IsAbleToHand()
end
...
function s.desfilter(c,e,tp)
	return c:IsFaceupEx() and c:IsControler(tp) and c:IsLocation(LOCATION_MZONE+LOCATION_HAND) and c:IsCode(100200282)

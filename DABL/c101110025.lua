...
function c101110025.disop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetFlagEffectLabel(tp,101110025)==cid or not Duel.SelectEffectYesNo(tp,e:GetHandler(),aux.Stringid(101110025,3)) then return end
	c:RegisterFlagEffect(101110025,RESETS_STANDARD,0,1)
	Duel.RegisterFlagEffect(tp,101110025,RESET_CHAIN,0,1,cid)

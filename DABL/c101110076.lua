...
function c101110076.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(101110076,0))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetCountLimit(1,101110076)
	e1:SetTarget(c101110076.sptg)
	e1:SetOperation(c101110076.spop)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
	...
	e4:SetDescription(aux.Stringid(101110076,2))

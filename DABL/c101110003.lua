...
function c101110003.initial_effect(c)
	...
	e1:SetCondition(c101110003.quickcon1)
	e1:SetCost(c101110003.tgcost)
	e1:SetTarget(c101110003.tgtg)
	e1:SetOperation(c101110003.tgop)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
	...
	e2:SetCondition(c101110003.quickcon2)
	c:RegisterEffect(e2)
end
function c101110003.tgcost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c101110003.tgtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsControler(1-tp) and chkc:IsLocation(LOCATION_MZONE) and chkc:IsFaceup() end
	if chk==0 then return Duel.IsExistingMatchingCard(c101110003.tgfilter,tp,LOCATION_EXTRA,0,1,nil)
...
function c101110003.tgop(e,tp,eg,ep,ev,re,r,rp)
...
function c101110003.quickcon1(e,tp,eg,ep,ev,re,r,rp)
	return not Duel.IsExistingMatchingCard(c101110003.quickconfilter,tp,LOCATION_MZONE,0,1,nil)
end
function c101110003.quickconfilter(c)
	return c:IsFaceup() and c:IsType(TYPE_SYNCHRO) and c:IsAttribute(ATTRIBUTE_DARK)
end
function c101110003.quickcon2(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c101110003.quickconfilter,tp,LOCATION_MZONE,0,1,nil)
end
...
function s.thfilter(c)
	return c:IsSetCard(0x2d2) and c:IsType(TYPE_SPELL) and c:IsAbleToHand()
end
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0x2d2) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end

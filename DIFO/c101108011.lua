...
function c101108011.sclawfilter(c,tp)
	return c:IsFaceup() and c:IsSetCard(0x27b)
end
function c101108011.checkzone(tp)
	local zone=0
	local lg=Duel.GetMatchingGroup(c101108011.sclawfilter,tp,LOCATION_MZONE,0,nil)
...
function c101108011.hspcon(e,c)
	...
	local zone=c101108011.checkzone(tp)
...
function c101108011.atktg(e,c)
	return c101108011.sclawfilter(c) and c:GetSequence()>=5
end
function c101108011.atkval(e)

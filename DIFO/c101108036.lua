...
function c101108036.initial_effect(c)
	c:EnableReviveLimit()
	aux.AddFusionProcFun2(c,c101108036.mfilter,aux.FilterBoolFunction(Card.IsFusionAttribute,ATTRIBUTE_DARK),true)
	--negate activation
...
function c101108036.negtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=Duel.GetMatchingGroup(c101108036.negcfilter,tp,0,LOCATION_MZONE,nil)

...
function c101108065.acfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x15f) and c:IsLevelAbove(7)
end
function c101108065.actcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetCurrentPhase()==PHASE_MAIN1 and Duel.IsExistingMatchingCard(Card.IsSummonType,e:GetHandlerPlayer(),0,LOCATION_MZONE,1,nil,SUMMON_TYPE_SPECIAL) and Duel.IsExistingMatchingCard(c101108065.acfilter,e:GetHandlerPlayer(),LOCATION_MZONE,0,1,nil)
end

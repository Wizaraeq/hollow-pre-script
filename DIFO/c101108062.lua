...
function c101108062.initial_effect(c)
	...
	e3:SetTarget(c101108062.thtg1)
	e3:SetOperation(c101108062.thop1)
	c:RegisterEffect(e3)
	--To Hand
...
function c101108062.thfilter1(c)
	return c:IsSetCard(0x1066) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
function c101108062.thtg1(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c101108062.thfilter1,tp,LOCATION_DECK,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
end
function c101108062.thop1(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectMatchingCard(tp,c101108062.thfilter1,tp,LOCATION_DECK,0,1,1,nil)

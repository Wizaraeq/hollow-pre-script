...
function s.negcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return rg:CheckSubGroup(aux.gffcheck,2,2,s.cfilter1,0,s.cfilter2,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g=rg:SelectSubGroup(tp,aux.gffcheck,false,2,2,s.cfilter1,0,s.cfilter2,nil)

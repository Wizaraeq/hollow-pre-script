...
function s.lvtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if op==0 then
		...
		local sg1=Duel.GetMatchingGroup(s.costfilter,tp,LOCATION_HAND+LOCATION_GRAVE,0,nil)
		local g1=sg1:SelectSubGroup(tp,aux.dabcheck,false,1,2)
		...
		local sg2=Duel.GetMatchingGroup(s.tgfilter,tp,LOCATION_REMOVED,0,nil)
		local g2=sg2:SelectSubGroup(tp,aux.dabcheck,false,1,2)

...
function s.disop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.NegateEffect(ev) and #g>0 and Duel.SelectYesNo(tp,1104) then
...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and Duel.IsExistingTarget(s.filter,tp,LOCATION_GRAVE,0,1,nil,c,e,tp) end

...
function c101104092.initial_effect(c)
	...
	e1:SetCondition(c101104092.condition)
	e1:SetTarget(c101104092.target)
	e1:SetOperation(c101104092.operation)
	c:RegisterEffect(e1)
end
...
function c101104092.condition(e,tp,eg,ep,ev,re,r,rp)
	local ph=Duel.GetCurrentPhase()
	return (ph==PHASE_MAIN1 or ph==PHASE_MAIN2) and eg:IsExists(c101104092.cfilter,1,nil,tp,rp)
end
function c101104092.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chk==0 then return Duel.IsExistingMatchingCard(nil,tp,0,LOCATION_ONFIELD,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_DESTROY,nil,1,1-tp,LOCATION_ONFIELD)
end
function c101104092.operation(e,tp,eg,ep,ev,re,r,rp)

...
function c100297011.initial_effect(c)
	...
	e2:SetCondition(c100297011.thcon2)
...
function c100297011.thcon2(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return c:IsReason(REASON_DESTROY) and c:IsReason(REASON_BATTLE+REASON_EFFECT)
end
function c100297011.thfilter2(c,tp)
	return c:IsType(TYPE_FIELD) and Duel.IsExistingMatchingCard(c100297011.codefilter,tp,LOCATION_DECK,0,1,nil,c)
end
...
function c100297011.thtg2(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c100297011.thfilter2(chkc,tp) end

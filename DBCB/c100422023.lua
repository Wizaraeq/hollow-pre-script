...
function s.spfilter(c,e,tp,res)
	return c:IsFaceupEx() and c:IsSetCard(0x2c2)
...
function s.lpfilter(c)
	return c:IsSetCard(0x2c2) and c:IsType(TYPE_LINK) and c:IsFaceup()
end
...
function s.cfilter(c,e,tp)
	return c:IsSetCard(0x2c2) and c:IsFaceup() and c:IsAbleToRemoveAsCost()

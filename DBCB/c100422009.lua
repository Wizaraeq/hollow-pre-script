...
function s.tdfilter(c)
	return not c:IsCode(id) and c:IsSetCard(0x2bd) and c:IsAbleToDeck() and c:IsLocation(LOCATION_GRAVE)
end
...
function s.disfilter(c)
	return c:IsType(TYPE_XYZ) and c:IsSetCard(0x2bd) and c:IsFaceup() and c:CheckRemoveOverlayCard(c:GetControler(),1,REASON_EFFECT)
end
